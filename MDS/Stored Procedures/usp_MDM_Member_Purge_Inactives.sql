...
/*
====================================================================================================
-- Create/Alter procedure usp_MDM_Member_Purge_Inactives
...
-- TEST:
	...
	EXEC dbo.usp_MDM_Member_Purge_Inactives @Entity='AttributeVal', @Model='Store_Attributes'
	
	--DROP PROCEDURE dbo.usp_MDM_Member_Purge_Inactives
====================================================================================================
*/

CREATE PROCEDURE dbo.usp_MDM_Member_Purge_Inactives
	@Entity VARCHAR(250),
	@Model VARCHAR(250),
	@ProcessID INT = -1
AS
	...
	SET @Job_ID = 7
	SET @Job_Shrt_Desc = 'usp_MDM_Member_Purge_Inactives'

	--******************************************** BEGIN PROCEDURE ********************************************

	SET @LogString = '**Begin purge of inactive members in MDS entity ' + @Entity + '.**'
	...
	BEGIN CATCH
        ...
        SELECT @LogString = @LogString + 'Procedure: usp_MDM_Member_Purge_Inactives'
        INSERT  INTO dbo.TALTH_JOB_LOG
        VALUES  ( @Job_ID, @ProcessID, @Job_Shrt_Desc, @LogString, GETDATE() )
